...
/> */}
      ...
      <Image 
        ...
        <ScrollView>
        <Card titletext=" النوادي الرياضيه" text="ستجد افضل  النوادي الرياضيه القريبه اليك مع افضل   العروض الترويجيه" imageSource={"http://167.71.56.133/api/public/" + GetMenuData?.data?.categoreis[0]?.cover}/>
