...
<Pressable
      ...
      <View>
            ...
            <Text style={styles.title}>تاسس متجر عام 1990 علي يد افضل المدربين  العرب والعالميين ومنهم المدرب يايسن جادو الحاصل على المركز الاول على العالم </Text>
...
export default BodyAboutStores